...
public class JhipsterSpotlessSampleApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSpotlessSampleApp.class);

    private final Environment env;

    public JhipsterSpotlessSampleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSpotlessSample.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSpotlessSampleApp.class);
